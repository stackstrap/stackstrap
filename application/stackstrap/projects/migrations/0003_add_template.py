...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'projects_project', 'template',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.Template'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'projects_project', 'template_id')
