...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Template.git_ref'
        db.add_column(u'projects_template', 'git_ref',
                      self.gf('django.db.models.fields.CharField')(default='master', max_length=64),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Template.git_ref'
        db.delete_column(u'projects_template', 'git_ref')
