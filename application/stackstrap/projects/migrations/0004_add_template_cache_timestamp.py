...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Template.last_cache_update'
        db.add_column(u'projects_template', 'last_cache_update',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Template.last_cache_update'
        db.delete_column(u'projects_template', 'last_cache_update')
