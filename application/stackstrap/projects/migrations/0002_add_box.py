...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Add the default box
        if not db.dry_run:
            default_box = orm['projects.box'].objects.create(
                    name='precise32',
                    url='http://files.vagrantup.com/precise32.box')

        # Adding field 'Project.box'
        db.add_column(u'projects_project', 'box',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=default_box.id, to=orm['projects.Box']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Project.box'
        db.delete_column(u'projects_project', 'box_id')
